...
- A tap now reveals the clear image with the existing restrained rainbow sparkle treatment; a second tap re-applies the blur.
...
- Added a reversible click/tap portrait reveal with spectral rainbow glow and sparkles.
